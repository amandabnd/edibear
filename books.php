<?php
    ...
    $totalbooksPages = ceil( count($user->fetchAll(array("id"), array("books_details"), array("status"=>1), "", $searchTagLike . " AND " . $searchKeyLike)) / 16);
    if ( isset($_GET['page']) ) {
...
<body>
    ...
    <div class="container-fluid py-3">
        ...
        <div class="d-flex pageheaderdiv">
            ...
            <div class="col-lg-8 ">
                <i class="fa fa-home pt-1 pr-2 text-primary"></i><a href="./">Home</a><i class="fa fa-angle-right pt-1 px-2 text-primary"></i>Books & Papers
                    ...
                    <div class="row pb-3">
                        <?php
                            if ( $booksPageNo > 1 ) {
                                ...
                                $other = "id<" . $user->fetchAll(array("id"), array("books_details"), array("status"=>"1"), "id DESC LIMIT $limit", $searchTagLike . " AND " . $searchKeyLike)[$limit-1]['id'];
                            } else {
                                $other = "";
                            }
                            if ( $other!="" ) {
