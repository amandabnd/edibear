...
class WIDGETS{
    ...
    public function testimonialData($testiArr, $admin=false) {
        ...
        $name = $testiArr['name'];
        $html = "
            <img src='$adminImageDot./img/Web pic/4.png' width='35px' alt='Testimonial'>
            ...
            for ( $i=1; $i<=5; $i++ ) {
                $starColor = ($i<=$ratings) ? "text-warning" : "";
    ...
    public function displayBlogBrief($row, $col="col-md-6", $wordCount=200) {
                ...
                <div class='blog-item'>
                    ...
                    <div class='bg-white p-2'>
                        <div class='d-flex mb-2' style='font-size:12px;'>
                            ...
                            <span class='text-warning pr-4'>$blogDate</span>
                        ...
                        <p class='m-0 text-justify text-decoration-none'>$blogDescription <a href='./blog?id=".$row['id']."'><br>Read More</a></p>
                    </div>
                </div>
            </div>
        ";
...
<!------------
                <div class='bg-white p-2'>
                    <div class='d-flex mb-2' style='font-size:12px;'>
                        <i class='fa fa-calendar-alt fa-sm text-warning p-1'></i>
                        <span class='text-warning pr-4'>$ad1Date</span>
                        <i class='fa fa-tag fa-sm text-warning p-1'></i>
                        <span class='text-warning'>".$row['tag']."</span>
                    </div>
                    <h5 class='text-primary text-uppercase font-weight-bold mb-0'>".$row['title']."</h5>
...
public function displaypdfBrief($row, $col="col-md-6", $wordCount=200, $isHome) {
        ...
        <div class='$col mb-4 pb-2'>
            <div class='blog-item'>
                ...
                <div class='bg-white p-2'>
                    <div class='d-flex mb-2' style='font-size:12px;'>
                        <i class='fa fa-calendar-alt fa-sm text-warning p-1'></i>
                        <span class='text-warning pr-4'>$pdfDate</span>
                        <i class='fa fa-tag fa-sm text-warning p-1'></i>
                        <span class='text-warning'>".$row['tag']."</span>
                    </div>
                    <h5 class='text-primary text-uppercase font-weight-bold mb-0' >".$row['title']."</h5>
...
public function displayhomeworkBrief($row, $col="col-md-6", $wordCount=200, $isHome) {
...
public function displaybooksBrief($row, $col="col-md-6", $wordCount=200, $isHome) {
