...
<body>
    ...
    <div class="container-fluid py-3">
        <div class="container pt-3">
            <i class="fa fa-home pt-1 pr-2 text-primary"></i><a href="./">Home</a><i class="fa fa-angle-right pt-1 px-2 text-primary"></i>Fun Activities
                ...
                <div class="d-flex flex-wrap m-n1">
                    <?php
                        foreach ( $tagsArr as $tag ) {
                            echo "<a style='color:#000;  border-color:#a7a7a7; border-style:solid; border-width: 1px;' class='px-3 py-1 mr-1 mb-2'  href='./blogs?tag=$tag' class='btn btn-light m-1'>$tag</a>";
