...
<body>
    ...
    <div class="container-fluid py-5" style="margin-top: 70px !important;">
        <div class="container">
            <i class="fa fa-home pt-1 pr-2 text-primary"></i><a href="./">Home</a><i class="fa fa-angle-right pt-1 px-2 text-primary"></i>edi's Story
            <h4 class="text-warning mt-2">edi's Story</h4>
            <div class="row mt-4">
                <div class="col-12 text-center">
                <h1 class="text-primary mb-3">edi's Story</h1>
